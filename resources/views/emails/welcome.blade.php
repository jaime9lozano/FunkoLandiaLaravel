...
<div>
    ...
    <p>Accede a nuestra plataforma <a href="{{ route('funkos.index') }}">aquí</a> para comenzar a explorar todas las funciones y servicios que ofrecemos.</p>

    <p>Si tienes alguna pregunta o necesitas asistencia, no dudes en contactarnos a través de <a href="macjavaserver@gmail.com">macjavaserver@gmail.com</a>.</p>
